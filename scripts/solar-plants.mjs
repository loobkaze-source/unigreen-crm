...
export const LINKS = {
  ...
  8: ["PTT Station ปตท.แยกอนุกูลนารี (น้ำมัน+EV)", "สถานีเดียวกับชื่อระบบโซลาร์"],
  9: ["PTT Station ปตท.แยกอนุกูลนารี (น้ำมัน+EV)", "สถานีเดียวกับชื่อระบบโซลาร์"],
  ...
  21: ["ปั๊ม ปตท.บจก.รัตนชาติ 999", "ที่อยู่เป็นถนนทุ่งโพธิ์ ตรงกับชื่อระบบโซลาร์"],
  22: ["PTT Station (Petrol+EV)", "ที่อยู่เป็น ต.นางั่ว ตรงกับชื่อระบบโซลาร์"],
  23: ["PTT Station (Petrol+EV)", "ที่อยู่เป็น ต.นางั่ว ตรงกับชื่อระบบโซลาร์"],
  ...
  35: ["PTT Station ปตท. สาขา พระยาตรัง - ท่าใหม่", "สถานีเดียวกับชื่อระบบโซลาร์"],
  36: ["PTT Station ปตท. สาขา พระยาตรัง - ท่าใหม่", "สถานีเดียวกับชื่อระบบโซลาร์"],
  ...
  47: ["อเมซอนสตาร์ (ห้าแยก)", "ชื่อไซต์ตรงกับชื่อระบบโซลาร์"],
  52: ["21082025_บางจาก เชียงของ", "ชื่อไซต์ตรงกับชื่อระบบโซลาร์ และมีอุปกรณ์อยู่แล้ว 11 ชิ้น"],
  53: ["PTT Station ปตท.สะพานพระราม 5 (ขาเข้า) (น้ำมัน+EV)", "สถานีเดียวกับชื่อระบบโซลาร์"],
  55: ["ปตท. หจก.โพธิ์สว่างออยล์", "ชื่อไซต์ตรงกับชื่อระบบโซลาร์"],
