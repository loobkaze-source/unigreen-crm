...
const ASSETS = {
  ...
  cols: [
    ...
    { key: "company_name", type: "ข้อความ", width: 30,
      desc: "ชื่อลูกค้าเจ้าของไซต์ — จำเป็นเมื่อมีไซต์ชื่อซ้ำกันหลายราย (เช่น “ระยอง” มี 9 แห่งคนละลูกค้า) ถ้าชื่อไซต์ไม่ซ้ำจะเว้นว่างได้" },
    { key: "name", req: true, type: "ข้อความ", width: 30,
  ...
  examples: [
    ["PT บางปู สมุทรปราการ", "บริษัท ไทยรุ่งเรือง ปิโตรเลียม จำกัด", "อินเวอร์เตอร์ตัวที่ 1", "INV-001", "object", "inverter", "Huawei", "SUN2000-100KTL-M1",
      "HV2340019876", "", "อาคาร A", "2024-06-12", "2024-06-12", "60", "operational", ""],
    ["PT บางปู สมุทรปราการ", "บริษัท ไทยรุ่งเรือง ปิโตรเลียม จำกัด", "ตู้เติมลมโครงเหล็ก-Outdoor", "AIR-014", "object", "other", "G5", "",
      "6972220250521", "", "อาคาร A", "2024-06-12", "2024-06-12", "24", "operational", "ประเภทที่ไม่เข้าพวกให้ใช้ other"],
    ["คลังสินค้าลาดกระบัง", "ห้างหุ้นส่วนจำกัด เอ็นเนอร์ยี่ พลัส", "โครงการติดตั้งโซลาร์ 1.2 MW", "", "project", "other", "", "",
      "", "PRJ-2024-0087", "", "2024-11-01", "2024-11-01", "60", "operational", "asset_type = project จึงกรอก project_number แทน serial_number"],
    ["สาขาระยอง (อาคาร A)", "บริษัท สุขสบาย เซอร์วิส จำกัด", "ตู้ชาร์จ EV จุดที่ 3", "EV-003", "object", "ev_charger", "Delta", "AC Max 22kW",
